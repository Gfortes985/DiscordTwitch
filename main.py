...
async def on_ready():
    ...
    async def live_notifs_loop():
        ...
        if streamers is not None:
            ...
            guild = bot.get_guild(891338278345789470)
            channel = bot.get_channel(992206743834722314)
            role = get(guild.roles, id=992210771482251306)
...
bot.run("OTkyMjAyMzg2MzA5MzgyMTU0.GKXGul.Ib3w6BevAgQYv99youRIEsS2Lb28V0SAlLN2Ao")